...
class dizplayz:
    ...
    def init_seqs(self):
        # frames themselves loaded in main.py, but code in frames.py
        render_seq_dict={}
        render_seq_dict['winks']=[0,0,0,1,2,2,1,0,0,3,4,4,3,0,0,5,6,6,5,0,0,0]
        render_seq_dict['winks'].reverse()
        return render_seq_dict

    def show_frame(self, frame_list, render_seq_dict, anim_id, frame_index):
